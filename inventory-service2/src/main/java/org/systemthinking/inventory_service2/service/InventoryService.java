package org.systemthinking.inventory_service2.service;
...
import org.systemthinking.inventory_service2.exception.InventoryServiceException;
import org.systemthinking.inventory_service2.repository.InventoryRepository;
...
public  void reserveInventory(InventoryRequest inventoryRequest){
    ...
    public void  releaseInventory(InventoryRequest request){
        ...
        for(InventoryRequest.InventoryItemRequest item : request.getItems()){
